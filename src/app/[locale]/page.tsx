    ...
    <div className="mx-auto flex max-w-7xl flex-col gap-20 px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section className="grid gap-8 lg:grid-cols-[1.15fr,0.85fr] lg:items-center">
        <div className="space-y-8">
          ...
          <Card className="grid gap-4 p-4 lg:grid-cols-[1fr,auto] lg:items-center">
            <div>
              <p className="text-sm text-muted-foreground">Aqlli qidiruv</p>
          ...
          <div className="relative space-y-5 p-1">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                ...
                ["Kutubxona aylanmasi", "Band qilish, qaytarish va kechikish nazorati"],
                ["Xavfsiz kirish", "Rollar asosida xavfsiz kirish va professional boshqaruv"]
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.24em] text-primary">Tanlangan resurslar</p>
      ...
      <section className="space-y-6">
        <div>
          <p className="text-sm uppercase tracking-[0.24em] text-primary">Kafedralar bo‘yicha resurs markazi</p>
        ...
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {departments.map((department) => (
            <Card key={department.id} className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">Eng faol fan va oxirgi yangilanish statistikasi keyingi bosqichda chuqurlashtiriladi.</p>
      ...
      <section className="space-y-6">
        <div>
          <p className="text-sm uppercase tracking-[0.24em] text-primary">O‘quv zali bandligi</p>
